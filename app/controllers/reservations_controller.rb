class ReservationsController < ApplicationController
	...
	def create
		...
		if @reservation
			values ={
				business: 'iampallavi15-facilitator@gmail.com',
				cmd: '_xclick',
				upload: 1,
				notify_url: 'http://becdc5ac.ngrok.io/notify',
				amount: @reservation.total,
				item_name: @reservation.room.listing_name,
				item_number: @reservation.id,
				quantity: '1',
				return: 'http://becdc5ac.ngrok.io/your_trips'
			}

			redirect_to "https://www.sandbox.paypal.com/cgi-bin/websrc?" +values.to_query

			#send a request to paypal, otherwise redirect back alert
		else
